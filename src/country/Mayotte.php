...
{
    public $country_code = "YT";
    public $country_name = "Mayotte";
    ...
    public $iban_example = "YT3120041010050500013M02606";
    public $iban_format_swift = "YT2!n5!n5!n11!c2!n";
    public $iban_format_regex = "^YT(\d{2})(\d{5})(\d{5})([A-Za-z0-9]{11})(\d{2})$";
    ...
    public $country_code_iana = "yt";
    public $country_code_iso3166_1_alpha2 = "YT";
