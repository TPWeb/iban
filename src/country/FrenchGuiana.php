...
{
    public $country_code = "GF";
    public $country_name = "French Guiana";
    ...
    public $iban_example = "GF4120041010050500013M02606";
    public $iban_format_swift = "GF2!n5!n5!n11!c2!n";
    public $iban_format_regex = "^GF(\d{2})(\d{5})(\d{5})([A-Za-z0-9]{11})(\d{2})$";
    ...
    public $country_code_iana = "gf";
    public $country_code_iso3166_1_alpha2 = "GF";
