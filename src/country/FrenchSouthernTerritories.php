...
{
    public $country_code = "TF";
    public $country_name = "French Southern Territories";
    ...
    public $iban_example = "TF2120041010050500013M02606";
    public $iban_format_swift = "TF2!n5!n5!n11!c2!n";
    public $iban_format_regex = "^TF(\d{2})(\d{5})(\d{5})([A-Za-z0-9]{11})(\d{2})$";
    ...
    public $country_code_iana = "tf";
    public $country_code_iso3166_1_alpha2 = "TF";
