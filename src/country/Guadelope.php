...
class Guadelope extends Country
{
    public $country_code = "GP";
    public $country_name = "Guadelope";
    ...
    public $iban_example = "GP1120041010050500013M02606";
    public $iban_format_swift = "GP2!n5!n5!n11!c2!n";
    public $iban_format_regex = "^GP(\d{2})(\d{5})(\d{5})([A-Za-z0-9]{11})(\d{2})$";
    ...
    public $country_code_iana = "gp";
    public $country_code_iso3166_1_alpha2 = "GP";
