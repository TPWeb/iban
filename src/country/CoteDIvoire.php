...
class CoteDIvoire extends Country
{
    public $country_code = "CI";
    public $country_name = "Côte d'Ivoire";
    ...
    public $iban_example = "CI77A12312341234123412341234";
    public $iban_format_swift = "CI2!n1!a23!n";
    public $iban_format_regex = "^CI(\d{2})([A-Z]{1})(\d{23})$";
    ...
    public $country_code_iana = "ci";
    public $country_code_iso3166_1_alpha2 = "CI";
