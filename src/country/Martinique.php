...
{
    public $country_code = "MQ";
    public $country_name = "Martinique";
    ...
    public $iban_example = "MQ5120041010050500013M02606";
    public $iban_format_swift = "MQ2!n5!n5!n11!c2!n";
    public $iban_format_regex = "^MQ(\d{2})(\d{5})(\d{5})([A-Za-z0-9]{11})(\d{2})$";
    ...
    public $country_code_iana = "mq";
    public $country_code_iso3166_1_alpha2 = "MQ";
