...
{
    public $country_code = "WF";
    public $country_name = "Wallis and Futuna";
    ...
    public $iban_example = "WF9120041010050500013M02606";
    public $iban_format_swift = "WF2!n5!n5!n11!c2!n";
    public $iban_format_regex = "^WF(\d{2})(\d{5})(\d{5})([A-Za-z0-9]{11})(\d{2})$";
    ...
    public $country_code_iana = "wf";
    public $country_code_iso3166_1_alpha2 = "WF";
