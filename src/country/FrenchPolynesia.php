...
{
    public $country_code = "PF";
    public $country_name = "French Polynesia";
    ...
    public $iban_example = "PF5720041010050500013M02606";
    public $iban_format_swift = "PF2!n5!n5!n11!c2!n";
    public $iban_format_regex = "^PF(\d{2})(\d{5})(\d{5})([A-Za-z0-9]{11})(\d{2})$";
    ...
    public $country_code_iana = "pf";
    public $country_code_iso3166_1_alpha2 = "PF";
