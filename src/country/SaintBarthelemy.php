...
class SaintBarthelemy extends Country
{
    public $country_code = "BL";
    public $country_name = "Saint Barthélemy";
    ...
    public $iban_example = "BL6820041010050500013M02606";
    public $iban_format_swift = "BL2!n5!n5!n11!c2!n";
    public $iban_format_regex = "^BL(\d{2})(\d{5})(\d{5})([A-Za-z0-9]{11})(\d{2})$";
    ...
    public $country_code_iso3166_1_alpha2 = "BL";
