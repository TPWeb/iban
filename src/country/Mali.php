...
{
    public $country_code = "ML";
    public $country_name = "Mali";
    ...
    public $iban_example = "ML75A12312341234123412341234";
    public $iban_format_swift = "ML2!n1!a23!n";
    public $iban_format_regex = "^ML(\d{2})([A-Z]{1})(\d{23})$";
    ...
    public $country_code_iana = "ml";
    public $country_code_iso3166_1_alpha2 = "ML";
